...
const BRAND = {
    ...
    phoneTel: "+15738256415",
    email: "lacastro.44@icloud.com",
    serviceAreas: ["Columbia", "Ashland", "Jefferson City"],
};
                    ...
                    <div className="mx-auto max-w-6xl">
                        <div className="mx-auto max-w-3xl text-center">
                            <div className="inline-block relative">
                                ...
                                <h1 className="mt-2 text-3xl sm:text-4xl lg:text-5xl font-semibold text-(--elite-green)">
