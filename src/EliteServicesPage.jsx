...
const BRAND = {
  ...
  serviceAreas: ["Columbia", "Jeferson"],
};
...
export default function EliteServicesPage() {
  ...
  return (
    <div
      className="
        min-h-screen bg-white text-gray-900 relative
    ...
    >
          ...
          <div className="bg-white/80 backdrop-blur-sm shadow-xl border border-white/40 p-10 sm:p-14 rounded-2xl">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  className="px-8 py-3 text-lg rounded-xl shadow-sm transition duration-200"
                  onClick={() => setContactOpen(true)}
                >
                  Ask About Bundles
                </Button>
          ...
          <div className="bg-white/80 backdrop-blur-sm shadow-xl border border-white/40 p-8 sm:p-12 rounded-2xl">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg mb-4 text-justify text-gray-800">
                ...
                focus on consistent quality and clear communication.
              </p>
      ...
      <div className="py-20 px-4 max-w-6xl mx-auto">
        <div className="bg-white/80 backdrop-blur-sm shadow-xl border border-white/40 p-6 sm:p-10 rounded-2xl">
